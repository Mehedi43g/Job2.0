...
const CallLogs = () => {
  return (
    <section>
      <div className="flex flex-col gap-3  md:flex md:flex-row md:gap-3 justify-between">
        <div className="md:w-5/12">
          <div className="relative">
            <form action="">
              <input className=' rounded-2xl outline-none font-inter border border-[#2B7FFF] py-3
           text-[#62748E] w-full pl-10' type="text" placeholder='Search by phone number, issue type...' />
            </form>
        ...
        <div className="w-6-12 md:mx-auto ">
          <div className="lg:flex md:flex-row md:gap-20 flex flex-col gap-4 ">
            <div className="">
              <select className="text-white text-sm font-inter bg-[#0b1437] w-full  md:w-30 px-2 py-3  rounded-lg  border border-white/20 focus:outline-none  focus:ring-1 focus:ring-white/30">
